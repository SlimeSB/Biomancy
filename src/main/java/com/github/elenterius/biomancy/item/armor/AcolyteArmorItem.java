...
public final class AcolyteArmorItem extends ArmorItem implements GeoItem, ItemTooltipStyleProvider {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

	public AcolyteArmorItem(ArmorMaterial material, Type type, Properties properties) {
